...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { contact: @buyer.contact, description: @buyer.description, product: @buyer.product, quantity: @buyer.quantity, sn: @buyer.sn } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { contact: @buyer.contact, description: @buyer.description, product: @buyer.product, quantity: @buyer.quantity, sn: @buyer.sn } }
